...
class FieldSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->create(0, 18, 'blue', []);
        $this->create(0, 18, 'header', []);
        $this->create(0, 18, 'description', []);
        $this->create(0, 18, 'service_1_image', []);
        $this->create(0, 18, 'service_1_title', []);
        $this->create(0, 18, 'service_1_description', []);
        $this->create(0, 18, 'service_1_link', []);
        $this->create(0, 18, 'service_2_image', []);
        $this->create(0, 18, 'service_2_title', []);
        $this->create(0, 18, 'service_2_description', []);
        $this->create(0, 18, 'service_2_link', []);
        $this->create(0, 18, 'service_3_image', []);
        $this->create(0, 18, 'service_3_title', []);
        $this->create(0, 18, 'service_3_description', []);
        $this->create(0, 18, 'service_3_link', []);
        $this->create(0, 18, 'service_4_image', []);
        $this->create(0, 18, 'service_4_title', []);
        $this->create(0, 18, 'service_4_description', []);
        $this->create(0, 18, 'service_4_link', []);
        $this->create(0, 18, 'service_5_image', []);
        $this->create(0, 18, 'service_5_title', []);
        $this->create(0, 18, 'service_5_description', []);
        $this->create(0, 18, 'service_5_link', []);
