...
class FieldValueSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $fieldValue = new FieldValue;
        $fieldValue->page_widget_id = 1;
        $fieldValue->field_id = 3;//description
        $fieldValue->setTranslations('value',[
        ...
        $fieldValue = new FieldValue;
        $fieldValue->page_widget_id = 1;
        $fieldValue->field_id = 4;//description
        $fieldValue->setTranslations('value',[
            'en' => '/uploads/nordicstandard/bg-shape-6.svg',
            'da' => '/uploads/nordicstandard/bg-shape-6.svg',
        ]);
        $fieldValue->save();

        $fieldValue = new FieldValue;
        $fieldValue->page_widget_id = 1;
        $fieldValue->field_id = 5;//description
        $fieldValue->setTranslations('value',[
            'en' => '/uploads/nordicstandard/bg-shape-5.svg',
            'da' => '/uploads/nordicstandard/bg-shape-5.svg',
        ]);
        $fieldValue->save();
