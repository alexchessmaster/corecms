<div class="form-group">
    ...
    <input type="text" class="form-control @error('name') is-invalid @enderror" 
           id="name" name="name" 
           value="{{ old('name', isset($bookAuthor) ? $bookAuthor->name : '') }}" 
...
<div class="form-group">
    ...
    <input type="date" class="form-control @error('date_of_death') is-invalid @enderror" 
           id="date_of_death" name="date_of_death" 
...
<div class="form-group">
    ...
    <input type="text" class="form-control @error('nationality') is-invalid @enderror" 
           ...
           value="{{ old('nationality', isset($bookAuthor) ? $bookAuthor->nationality : '') }}" 
...
<div class="form-group">
    ...
    <textarea class="form-control @error('biography') is-invalid @enderror" 
              ...
              placeholder="Enter author biography">{{ old('biography', isset($bookAuthor) ? $bookAuthor->biography : '') }}</textarea>
    @error('biography')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
