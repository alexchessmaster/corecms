...
namespace App\Modules\Insights\Http\Controllers\Admin;

use App\Http\Controllers\Controller;
use App\Modules\Insights\Models\UrlLog;
use Illuminate\Http\Request;
use Illuminate\Support\Carbon;
use Yajra\DataTables\Facades\DataTables;
use App\Modules\Insights\Http\Requests\StoreUrlLogRequest;
use App\Modules\Insights\Http\Requests\UpdateUrlLogRequest;
...
class UrlLogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('insights::url-log.index');
    }
    ...
    public function statistic()
    {
        ...
        return view('insights::url-log.statistics', compact('labelString', 'dataString'));
    }
