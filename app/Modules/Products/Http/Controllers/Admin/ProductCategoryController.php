...
class ProductCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('products::product_category.index');
    }
    ...
    public function create()
    {
        ...
        return view('products::product_category.create', compact('productCategories'));
    }
    ...
    public function edit($productCategoryId)
    {
        ...
        return view('products::product_category.edit', compact('productCategory', 'productCategories', 'allWidgets', 'authToken'));
    }
