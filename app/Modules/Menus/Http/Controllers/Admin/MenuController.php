...
use App\Modules\Menus\Http\Requests\StoreMenuRequest;
use App\Modules\Menus\Http\Requests\UpdateMenuRequest;
...
class MenuController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('menus::menu.create', compact('menus'));
    }
    ...
    public function edit(Menu $menu)
    {
        ...
        $menus = Menu::orderBy('order')->get();
        return view('menus::menu.edit', compact('menus', 'menu'));
    }
