...
class ContentController extends Controller
{
    ...
    //     if ($page) {
    //         $responseData["content"] = PageResource::make($page);
    ...
    //     if ($category) {
    //         $responseData["content"] = CategoryResource::make($category);
    ...
    //     if ($tag) {
    //         $responseData["content"] = TagResource::make($tag);
    ...
    //         $responseData["content_prefix"] = $articlePrefix;
    //         $responseData["content"] = ArticleResource::make($article)->additional([
    //             'content_prefix' => $articlePrefix
    //         ]);
    ...
    //         $responseData["content_prefix"] = $productPrefix;
    //         $responseData["content"] = ProductResource::make($product)->additional([
    //             'content_prefix' => $productPrefix
    //         ]);
    ...
    //         $responseData["content_prefix"] = $bookPrefix;
    //         $responseData["content"] = BookResource::make($book)->additional([
    //             'content_prefix' => $bookPrefix
    //         ]);
    ...
    //     if ($news) {
    //         // here check if bookGenre is correct do it
    //         $responseData["content_prefix"] = $newsPrefix;
    //         $responseData["content"] = NewsResource::make($news)->additional([
    //             'content_prefix' => $newsPrefix
    //         ]);
