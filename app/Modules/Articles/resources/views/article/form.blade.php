<div class="mb-3">
    ...
    @if (isset($article) && App\Modules\Shared\Helpers\TranslationHelper::firstAvailableValue($article, 'image'))
        <div class="mb-2">
            <img src="{{ App\Modules\Shared\Helpers\TranslationHelper::firstAvailableValue($article, 'image') }}"
