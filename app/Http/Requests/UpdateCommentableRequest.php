...
class UpdateCommentableRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'commentable_type' => [
                'required',
                'string',
                Rule::in(['App\Modules\Books\Models\Book', 'App\Modules\Articles\Models\Article', 'App\Models\Page', 'App\Modules\Products\Models\Product', 'App\Modules\News\Models\News'])
            ],
            'commentable_id' => [
                'required',
                'integer',
